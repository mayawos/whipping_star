...
int main(int argc, char* argv[])
{
  ...
  bkg.WriteOut("DLCombinedFitDOF_bkg_spec");
  ...
  // Output tfile + ttree
  TFile* ana_file = TFile::Open("DLCombinedFitDOF_ana.root","RECREATE");
  ana_file->cd();
  ...
  for(size_t it = 0; it < 6; ++it) {
    ...
    std::stringstream ss;
    ss << "DLCombinedFitDOF_BF_chi_spec_" << it;
    ...
    ss.str("");
    ss << "DLCombinedFitDOF_lowest_spec_" << it;
