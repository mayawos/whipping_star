...
do
	...
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}${m}${a}_CV.SBNspec.root --background constrained_${t}_H1_${s}${m}${a}_BKG.SBNspec.root --poisson --tag constrained_${t}_H1_${s}${m}${a}_stats -r collapsed_zero_ext_bin_${t}_H1_${s}${m}${a}.SBNcovar.root 
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}${a}_CV.SBNspec.root --background constrained_${t}_H1_${s}_BKG.SBNspec.root --poisson --tag constrained_${t}_H1_${s}${a}_stats -r collapsed_zero_ext_bin_${t}_H1_${s}${m}${a}.SBNcovar.root 
	...
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}_CV.SBNspec.root --background constrained_${t}_H1_${s}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}_syst
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}${m}_CV.SBNspec.root --background constrained_${t}_H1_${s}${m}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}${m}.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}${m}_syst
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}${m}${a}_CV.SBNspec.root --background constrained_${t}_H1_${s}${m}${a}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}${m}${a}.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}${m}${a}_syst -r collapsed_zero_ext_bin_${t}_H1_${s}${m}${a}.SBNcovar.root
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}_CV.SBNspec.root --background constrained_${t}_H1_${s}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}${a}_syst -r collapsed_zero_ext_bin_${t}_H1_${s}${m}${a}.SBNcovar.root
	...
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}_CV.SBNspec.root --background constrained_${t}_H1_${s}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}_detsys.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}_syst_detsys
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}${m}_CV.SBNspec.root --background constrained_${t}_H1_${s}${m}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}${m}_detsys.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}${m}_syst_detsys
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}${m}${a}_CV.SBNspec.root --background constrained_${t}_H1_${s}${m}${a}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}${m}${a}_detsys.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}${m}${a}_syst_detsys -r collapsed_zero_ext_bin_${t}_H1_${s}${m}${a}.SBNcovar.root
	./sbnfit_lee_frequentist_study --xml const_${t}_H1_mc_collabOct.xml --signal constrained_${t}_H1_${s}_CV.SBNspec.root --background constrained_${t}_H1_${s}_BKG.SBNspec.root --covariance constrained_${t}_H1_${s}_detsys.SBNcovar.root -e 1e-7 --tag constrained_${t}_H1_${s}${a}_syst_detsys -r collapsed_zero_ext_bin_${t}_H1_${s}${m}${a}.SBNcovar.root
